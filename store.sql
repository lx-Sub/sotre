...
-- store.att_attendance definition
...
-- store.att_staff_leave definition
...
-- store.credit_record definition
...
-- store.exchange_order definition
...
-- store.operation_log definition
...
-- store.per_role_menu definition
...
-- store.per_staff_role definition
...
-- store.private_message definition
...
-- store.sal_salary_deduct definition
...
-- store.soc_insurance definition
...
-- store.user_equipment definition
...
-- store.user_favorite definition
